...
public class Photographer
{
    ...
    {
        //photoFileName should have full parh appended before calling the addFinishedWork method.
        String photoFileName = takePicture(assignment.getDescription());
        photoFileName = "/Users/mike/Dropbox/Udacity/lesson8/photographyShop/" + photoFileName;
    ...
    private void readPhotos()
    {
        ...
        try
        {
            Scanner in = new Scanner(new File("/Users/mike/Dropbox/Udacity/lesson8/photographyShop/photos.txt"));
