...
public class Simulation
{
    ...
    private static final Pattern newAssignmentPattern = Pattern.compile("([0-9]+) (.*)");//Verify that we see the path.
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        System.out.println("This program creates a simulation and reads a story. \n"
                           + "As it reads the stories, it calls the corresponding methods in the Manager");
        Manager manager = new Manager();
        try
        {
            Scanner in = new Scanner(new File("/Users/mike/Dropbox/Udacity/lesson8/photographyShop/story.txt"));
